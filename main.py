...
MIN_CAP = int(os.getenv("MIN_CAP", "100000 000")) # $100M
...
MAX_REQUESTS_PER_MINUTE = 30 # Обмеження до 30 запитів за хвилину
...
async def fetch_dexscreener_data():
 ...
 if liquidity < 10000: # Фільтруємо низьку ліквідність
 continue
 all_coins.append({
